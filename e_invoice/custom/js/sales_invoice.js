frappe.ui.form.on('Sales Invoice', {
    ...
    refresh: function (frm) {
        if (frm.doc.docstatus == 0) {
            frm.add_custom_button(__('Send Invoice Quest'), function () {
                frappe.confirm(
        ...
        if (frm.doc.docstatus == 0) {
            frm.add_custom_button(__('Send Invoice Mercuri'), function () {
                frappe.confirm(
                    __('Are you sure you want to send this invoice?'),
                    function () {
                        frappe.call({
                            method:
                                "e_invoice.custom.python.sales_invoice_mr.post_invoice",
                            freeze: true,
                            args: {
                                'docnames': [frm.doc.name]
                            },
        ...
        if (frm.doc.uuid) {
                frm.add_custom_button(__('Validate Invoice Quest'), function () {
                    frappe.confirm(
            ...
            if (frm.doc.uuid) {
                frm.add_custom_button(__('Validate Invoice mercuri'), function () {
                    frappe.confirm(
                        __('Are you sure you want to validate this invoice?'),
                        function () {
                            frappe.call({
                                method:
                                    "e_invoice.custom.python.sales_invoice_mr.validate_einvoice",
                                freeze: true,
                                args: {
                                    'docnames': [frm.doc.name]
                                },
        ...
        if (frm.doc.docstatus == 1) {
            ...
            if (frm.doc.is_return){
                frm.add_custom_button(__('Credit Note Mercuri'), function () {
                    frappe.confirm(
                        __('Are you sure you want to send credit note?'),
                        function () {
                            frappe.call({
                                method:
                                    "e_invoice.custom.python.sales_invoice_mr.credit_note",
                                freeze: true,
                                args: {
                                    'docnames': [frm.doc.name]
                                },
